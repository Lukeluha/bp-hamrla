...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		if (this.closeButton){
			...
			this.picker.find('a.datetimepicker-close').hide();
		}
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-chevron-left fi-arrow-left"/></th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-chevron-right fi-arrow-right"/></th>'+
							'</tr>'+
						'</thead>',
